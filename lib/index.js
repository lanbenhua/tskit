...
var init = function (dir, template, force) {
    ...
    if (force && isDirExists) {
        console.log(source.green("[tss] exists '".concat(fullDirPath, "'")));
        fs__default["default"].rmdirSync(dir, { recursive: true });
        console.log(source.green("[tss] removed '".concat(fullDirPath, "'")));
    }
...
var copy = function (fromDir, toDir) {
    ...
    if (!isExists(toDir)) {
        ...
        console.log(source.green("[tss] created '".concat(toDir, "'")));
    }
    ...
    fsPromise__default["default"].readdir(fromDir).then(function (dirChildren) {
        dirChildren.forEach(function (dirChild) {
            ...
            if (isFile(fromPath)) {
                ...
                console.log(source.green("[tss] created '".concat(toPath, "'")));
