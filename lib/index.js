...
var name = "tskit";
var version = "0.0.4";
var description = "ts starter cli";
...
var isExists = function (pathname) {
    try {
...
var isDirectory = function (pathname) {
    try {
        var stat = fs__default["default"].statSync(pathname);
...
var TEMPLATES_DIR = path__default["default"].resolve(process.cwd(), "templates");
var getTemplateDir = function (template) { return path__default["default"].resolve(TEMPLATES_DIR, template); };
var copy = function (fromDir, toDir) { return __awaiter(void 0, void 0, void 0, function () {
    var subFilenames;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (!isExists(fromDir))
                    throw new Error("".concat(fromDir, " is not exists"));
                if (!isDirectory(fromDir))
                    throw new Error("".concat(fromDir, " is not a directory"));
                if (!!isExists(toDir)) return [3 /*break*/, 2];
                return [4 /*yield*/, fs__default["default"].promises.mkdir(toDir, { mode: 511 })];
            case 1:
                _a.sent();
                console.log(source.green("[tskit] created dir: '".concat(toDir, "'")));
                _a.label = 2;
            case 2:
                if (!isDirectory(toDir))
                    throw new Error("".concat(toDir, " is not a directory"));
                return [4 /*yield*/, fs__default["default"].promises.readdir(fromDir)];
            case 3:
                subFilenames = _a.sent();
                subFilenames.forEach(function (filename) { return __awaiter(void 0, void 0, void 0, function () {
                    var fromPath, toPath;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                fromPath = path__default["default"].resolve(fromDir, filename);
                                toPath = path__default["default"].resolve(toDir, filename);
                                if (!isDirectory(fromPath)) return [3 /*break*/, 2];
                                return [4 /*yield*/, copy(fromPath, toPath)];
                            case 1: return [2 /*return*/, _a.sent()];
                            case 2:
                                if (isFile(fromPath)) {
                                    fs__default["default"].openSync(toPath, fs__default["default"].constants.O_RDWR | fs__default["default"].constants.O_CREAT | fs__default["default"].constants.O_TRUNC, 511);
                                    console.log(source.green("[tskit] created file: '".concat(toPath, "'")));
                                    fs__default["default"].createReadStream(fromPath, { mode: 511 }).pipe(fs__default["default"].createWriteStream(toPath, { mode: 511 }));
                                }
                                return [2 /*return*/];
                        }
                    });
...
var init = function (dir, template, force) { return __awaiter(void 0, void 0, void 0, function () {
    var fullpath, isCurrentDirExists;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                fullpath = path__default["default"].resolve(process.cwd(), dir);
                isCurrentDirExists = isExists(fullpath);
                if (!force && isCurrentDirExists)
                    throw new Error("".concat(fullpath, " exists, you can use '--force' or '-f' to force clear the directory"));
                if (!(force && isCurrentDirExists)) return [3 /*break*/, 2];
                console.log(source.green("[tskit] exists dir: '".concat(fullpath, "'")));
                return [4 /*yield*/, fs__default["default"].promises.rm(dir, { recursive: true, force: true })];
            case 1:
                _a.sent();
                console.log(source.green("[tskit] removed dir: '".concat(fullpath, "'")));
                _a.label = 2;
            case 2: return [4 /*yield*/, copy(getTemplateDir(template), fullpath)];
            case 3:
                _a.sent();
                return [2 /*return*/];
        }
...
var dirArgument = new Argument("<dir>", "required <char> the ts project directory you want to create");
var templateOption = new Option("-t, --template <char>", "the template directory you want to create")
    .default("ts", "default is ts directory")
    .choices(["ts"]);
var forceOptions = new Option("-f, --force", "whether force to clear and create the directory when it is exists");
program
    .name(name)
